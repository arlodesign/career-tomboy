<?php
/**
 * Plugin Name: Career Tomboy CPTs
 * Description: Custom post types, meta fields, and Vercel deploy hook for the Career Tomboy headless site.
 * Version: 1.0.0
 */
...
// Vercel Deploy Hook
//
// Set the hook URL in wp-config.php:
...
/**
 * Fire the deploy hook via a non-blocking POST request.
 */
